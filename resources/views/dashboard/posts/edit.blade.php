...
<form method="post" action="/dashboard/posts/{{ $post->slug }}" enctype="multipart/form-data">
    ...
    <div class="mb-3">
      ...
      <div class="mb-3">
        ...
        <select name="ewarung" class="form-control">
            ...
            @if (old('ewarung', $post->ewarung) == $e->ewarung )
                <option value="{{ $e->ewarung }}" selected> {{ $e->ewarung }}</option>
            @else
    ...
    <button type="submit" class="btn btn-primary mb-5">Upadate</button>
  </form>
